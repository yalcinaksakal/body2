...
const femaleBodyParts = [
  ...
  },
  {
    ...
    points: [
      ...
      new Vector3(-0.7, 5.66, -0.42),
      new Vector3(-0.62, 5.66, -0.14),
      new Vector3(-0.68, 5.66, -0.36),
    ],
  },
  {
    name: "Right Shoulder",
    points: [
      ...
      new Vector3(-1.02, 6.05, -0.1),
      new Vector3(-1.02, 5.72, -0.15),
      new Vector3(-1.02, 6.05, -0.49),
      new Vector3(-1.02, 6.07, -0.52),
      new Vector3(-0.68, 5.72, -0.52),
      new Vector3(-0.7, 5.66, -0.4),
      new Vector3(-0.7, 5.74, -0.22),
      new Vector3(-0.68, 5.88, -0.12),
      new Vector3(-0.76, 6.1, -0.22),
      new Vector3(-0.76, 6.1, -0.44),
      new Vector3(-0.66, 5.92, -0.6),
    ],
  },
  {
    name: "Left Shoulder",
  ...
  },
  {
    ...
    points: [
      ...
      new Vector3(0.24, 6.94, 0.1),
      new Vector3(0, 6.94, 0.25),
      new Vector3(-0.25, 6.94, -0.44),
      new Vector3(0.25, 6.94, -0.44),
      new Vector3(0, 6.94, -0.62),
      new Vector3(0, 7.16, -0.44),
      new Vector3(0, 7.22, -0.2),
      new Vector3(0, 7.14, 0.08),
      new Vector3(-0.26, 7.06, -0.08),
      new Vector3(0.26, 7.06, -0.08),
      new Vector3(-0.12, 7.12, 0.06),
      new Vector3(0.12, 7.12, 0.06),
      new Vector3(-0.37, 6.84, -0.35),
      new Vector3(0.37, 6.84, -0.35),
      new Vector3(-0.2, 7.16, -0.16),
      new Vector3(0.2, 7.16, -0.16),
      new Vector3(-0.2, 7.13, -0.46),
      new Vector3(0.2, 7.13, -0.46),
      new Vector3(-0.16, 6.84, -0.58),
      new Vector3(0.16, 6.84, -0.58),
      new Vector3(-0.18, 6.76, -0.54),
      new Vector3(0.18, 6.76, -0.54),
      new Vector3(0, 6.76, -0.6),
    ],
  },
  {
    name: "Head, Hair, Psyche",
